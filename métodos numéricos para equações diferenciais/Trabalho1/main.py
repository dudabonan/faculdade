...
from estabilidades import executar_perturbacoes, executar_lagrange
...
def main():
    while True:
        ...
        if opcao == '1':
            ...
            print("\nIniciando Atividade 3... Isso pode demorar alguns minutos.")
            executar_perturbacoes()
            pausar()
        elif opcao == '4':
            print("\nIniciando Atividade 4... Isso pode demorar alguns minutos.")
            executar_lagrange()
            pausar()
        elif opcao == '0':
